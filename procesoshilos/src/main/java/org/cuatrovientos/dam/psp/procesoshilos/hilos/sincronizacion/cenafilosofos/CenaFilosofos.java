...
public class CenaFilosofos {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Filosofo aristoteles = new Filosofo("Aristoteles", listaTenedores.get(0), listaTenedores.get(1));
			Filosofo kant = new Filosofo("Kant", listaTenedores.get(1), listaTenedores.get(2));
			Filosofo sartre = new Filosofo("Sartre", listaTenedores.get(2), listaTenedores.get(3));
			Filosofo platon = new Filosofo("Platon", listaTenedores.get(3), listaTenedores.get(4));
			Filosofo popper = new Filosofo("Popper", listaTenedores.get(4), listaTenedores.get(0));
